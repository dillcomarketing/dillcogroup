...
/* harmony import */ var _pages_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pages/index */ "./source/_assets/js/pages/index.js");


/***/ }),

/***/ "./source/_assets/js/embla.js":
/*!************************************!*\
  !*** ./source/_assets/js/embla.js ***!
  \************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var embla_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! embla-carousel */ "./node_modules/embla-carousel/embla-carousel.umd.js");
...
/* harmony import */ var embla_carousel_autoplay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! embla-carousel-autoplay */ "./node_modules/embla-carousel-autoplay/embla-carousel-autoplay.umd.js");
/* harmony import */ var embla_carousel_autoplay__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(embla_carousel_autoplay__WEBPACK_IMPORTED_MODULE_0__);



function initEmbla(parentElementSelector, options) {
  var _options$startIndex, _slideElements$start, _dotButtons$start, _options$loop;

  var start = (_options$startIndex = options === null || options === void 0 ? void 0 : options.startIndex) !== null && _options$startIndex !== void 0 ? _options$startIndex : 1;
  ...
  var slideElements = parent.querySelectorAll('.embla__slide');
  var dotButtons = parent.querySelectorAll('.embla__dot-button');
  var prevButton = parent.querySelector('.embla__prev-button');
  var nextButton = parent.querySelector('.embla__next-button');
  (_slideElements$start = slideElements[start]) === null || _slideElements$start === void 0 ? void 0 : _slideElements$start.classList.add('embla__slide--active');
  (_dotButtons$start = dotButtons[start]) === null || _dotButtons$start === void 0 ? void 0 : _dotButtons$start.classList.add('embla__dot-button--active');
  var plugins = [];

  if (options !== null && options !== void 0 && options.autoPlay) {
    plugins.push(embla_carousel_autoplay__WEBPACK_IMPORTED_MODULE_0___default()({
      delay: 3000
    }, parent));
  }

  var embla = embla_carousel__WEBPACK_IMPORTED_MODULE_1___default()(parent, {
    startIndex: start,
    loop: (_options$loop = options === null || options === void 0 ? void 0 : options.loop) !== null && _options$loop !== void 0 ? _options$loop : false
  }, plugins);
  embla.on('select', function () {
    var _slideElements$curren, _slideElements$previo, _dotButtons$current, _dotButtons$previous;

    var current = embla.selectedScrollSnap();
    var previous = embla.previousScrollSnap();
    (_slideElements$curren = slideElements[current]) === null || _slideElements$curren === void 0 ? void 0 : _slideElements$curren.classList.add('embla__slide--active');
    (_slideElements$previo = slideElements[previous]) === null || _slideElements$previo === void 0 ? void 0 : _slideElements$previo.classList.remove('embla__slide--active');
...
/* harmony default export */ __webpack_exports__["default"] = (initEmbla);

/***/ }),

/***/ "./source/_assets/js/pages/index.js":
/*!******************************************!*\
  !*** ./source/_assets/js/pages/index.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _embla__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../embla */ "./source/_assets/js/embla.js");

(0,_embla__WEBPACK_IMPORTED_MODULE_0__["default"])('#banners .embla', {
  autoPlay: true,
  loop: true
});
(0,_embla__WEBPACK_IMPORTED_MODULE_0__["default"])('#brands .embla', {
  loop: true,
  startIndex: 3
});
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], function() { return __webpack_require__("./source/_assets/js/app.js"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], function() { return __webpack_require__("./source/_assets/css/app.css"); })
